function calculateSalary() {
    // prompt the user for the basic salary and benefits information
...
// Output the results
  ...
  <strong style="color:red">NHIF Deduction: </strong> ${nhifDeduction.toFixed(
    2
  )}<br><strong style="color:red">NSSF Deduction: </strong>${nssfDeduction.toFixed(
    2
  )}<br><strong style="color:green" >YOUR NET SALARY IS: </strong>${netSalary.toFixed(
    2
  )}`;
